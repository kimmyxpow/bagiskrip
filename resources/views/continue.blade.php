...
@section('container')
<section class="grid sm:my-10 mt-8 sm:grid-cols-12 grid-cols-1 sm:gap-6 gap-1 py-8 sm:px-0 px-4">
   <div class="sm:col-span-10 col-span-1 sm:col-start-2 col-start-1 space-y-8">
            ...
            <div class="space-y-4 bg-white shadow-2xl py-12 px-8 rounded-xl">
               ...
               <div class="space-y-4">
                  ...
                  <div class="flex items-center space-x-2">
                     ...
                     <p class="font-poppins md:text-lg sm:text-base text-sm text-mycolor-light-text">Tidak dapat menambahkan password untuk kode.</p>
                  </div>
               </div>
            ...
            <div class="space-y-4 bg-white shadow-2xl py-12 px-8 rounded-xl">
               ...
               <div class="space-y-4">
                  ...
                  <div class="flex items-center space-x-2">
                     ...
                     <p class="font-poppins md:text-lg sm:text-base text-sm text-mycolor-light-text">Bisa menambah password untuk kode.</p>
                  </div>
               </div>
